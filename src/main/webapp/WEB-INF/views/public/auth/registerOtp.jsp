		...
		<aside>
			...
			<form action="/register-otp" method="POST" data-parsley-validate>
				...
				<div class="form-group">
					<span class="input">
					<input class="input_field" type="text" autocomplete="off" name="otp" value=""
						data-parsley-required data-parsley-required-message="Please type your code" >
						<label class="input_label">
						<span class="input__label-content">Your OTP code</span>
					</label>
					</span>
				</div>
